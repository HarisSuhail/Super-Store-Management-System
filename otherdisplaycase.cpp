...
#include <iomanip>
#include "menu.h"
#define SPORTSCSVDIR "sports.csv"
#define STATCSVDIR "stationery.csv"
...
int sports_menu()
{
		...
		switch(elec_Menu.displaymenu(74,15))
	{
		...
		case 4:
			...
			{
				gotoxy(posx, posy++);
				cout<<"ID"<<setw(22)<<"Title"<<setw(20)<<"Quantity"<<setw(20)<<"Barcode";
				gotoxy(posx, posy++);
				cout<<"--"<<setw(22)<<"-----"<<setw(20)<<"--------"<<setw(20)<<"-------";
		...
		case 5://display in spread sheet
			...
			//cout<<"Number"<<number;
			//_getch();
			excel.open(SPORTSCSVDIR, ios::out);
			if(number!=0)
